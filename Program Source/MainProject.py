...
df = pd.read_csv(r'USAPopDeciEditv2.csv',engine='python',encoding='latin1')

df = df[["state_id","state_name","county_name","lat","lng","FUNCSTAT","2010","2011","2012","2013","2014","2015","2016","2017PREDINT","2018PREDINT","2019PREDINT","2020PREDINT","TOTPRED"]].drop_duplicates()
